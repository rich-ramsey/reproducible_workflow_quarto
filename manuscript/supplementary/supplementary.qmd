...
It is labelled differently to reflect that it is a supplementary table (@tbl-example-s1).
...
This is a useful model diagnostic check to see that the model built ok (@fig-supp-plot).
